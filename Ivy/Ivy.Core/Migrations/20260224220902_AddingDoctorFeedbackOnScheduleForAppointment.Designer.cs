...
namespace Ivy.Core.Migrations
{
    ...
    [Migration("20260224220902_AddingDoctorFeedbackOnScheduleForAppointment")]
    partial class AddingDoctorFeedbackOnScheduleForAppointment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ivy.Core.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("DoctorFeedbackOnSchedule")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Ivy.Core.Entities.MedicalHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_MedicalHistories_CreatedAt");

                    b.HasIndex("CreatedByUserId")
                        .HasDatabaseName("IX_MedicalHistories_CreatedByUserId");

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_MedicalHistories_IsDeleted");
            ...
            modelBuilder.Entity("Ivy.Core.Entities.MedicalHistoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_MedicalHistoryItems_IsDeleted");

                    b.HasIndex("MediaType")
                        .HasDatabaseName("IX_MedicalHistoryItems_MediaType");
            ...
            modelBuilder.Entity("Ivy.Core.Entities.MedicalHistory", b =>
                {
                    b.HasOne("Ivy.Core.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Ivy.Core.Entities.MedicalHistoryItem", b =>
                {
                    b.HasOne("Ivy.Core.Entities.MedicalHistory", "MedicalHistory")
